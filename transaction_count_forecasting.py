...
# Iyzico is a financial technology company that simplifies the online shopping experience for both buyers and sellers.
# It provides payment infrastructure for e-commerce companies, marketplaces, and individual users.
# A projected estimate is expected for the total transaction volume on a merchant_id and daily basis for the last three months of 2020.
...
# Observe the transaction count graphs for the 5th member business for each year.
...
# Examination of transaction counts for member businesses on a monthly and yearly basis.

df.groupby(["merchant_id","year","month","day_of_month"]).agg({"Total_Transaction": ["sum", "mean", "median"]})

# Examination of total payment amounts for member businesses on a monthly and yearly basis.
